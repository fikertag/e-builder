...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  console.log(product, "product data in card");

  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105 border border-gray-100 group flex flex-col">
  ...
  <span className="bg-green-100 text-green-700 text-xs px-2 py-0.5 rounded-md">New</span>
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-3 py-1.5 rounded-lg shadow-md hover:from-indigo-600 hover:to-purple-700 hover:scale-105 transition-all duration-200 font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-400 cursor-pointer w-full"
        >
